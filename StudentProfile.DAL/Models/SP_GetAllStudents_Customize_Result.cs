...
namespace StudentProfile.DAL.Models
{
    ...
    public partial class SP_GetAllStudents_Customize_Result
    {
        ...
        public Nullable<double> LAST_CUM_GPA { get; set; }
        public Nullable<System.DateTime> InsertDate { get; set; }
        public Nullable<int> TOTAL_WARNINGS { get; set; }
        public Nullable<int> TOTAL_WITHDRANS { get; set; }
        public Nullable<int> TOTAL_TERMINATIONS { get; set; }
