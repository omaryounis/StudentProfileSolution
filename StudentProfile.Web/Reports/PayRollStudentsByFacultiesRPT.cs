...
{
    public partial class PayRollStudentsByFacultiesRPT : DevExpress.XtraReports.UI.XtraReport
    {
        private int rowIndex = 0;
        public PayRollStudentsByFacultiesRPT()
        {
            InitializeComponent();
        }

        private void PayRollStudentsByFacultiesRPT_AfterPrint(object sender, EventArgs e)
        {
