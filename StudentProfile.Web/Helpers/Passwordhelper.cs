...
namespace Dashboard_StudentProfile.Helpers
{
    public class Passwordhelper
    {
        ...
        public static StudentProfile.DAL.Models.DashBoard_Users Login(StudentProfile.DAL.Models.DashBoard_Users loggedUser)
        {
            ...
            StudentProfile.DAL.Models.DashBoard_Users user = new DashBoard_Users();
        ...
        public static string EncryptData(string strData)
        {
            ...
            try
            {
                ...
                using (var keyBytes = new Rfc2898DeriveBytes(System.Configuration.ConfigurationManager.AppSettings["encryption.MasterKey"].ToString(), salt))
                {
