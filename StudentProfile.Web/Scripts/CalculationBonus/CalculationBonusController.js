app.controller("CalculationBonusCtrl", ["$scope", "$http", 'CalculationBonusSrvc', function ($scope, $http, CalculationBonusSrvc) {
    ...
    $scope.StudentStatusAcademySelectedValues = null;
    $scope.StudentList = [];
    var StudentList = [];
    ...
    $scope.Listradiogroup2 = ["احتساب لكل الطلاب", "احتساب لطالب واحد"];
    $scope.Listradiogroup3 = ["مسير طلاب","مسير وزارة"];
    //Control
    ...
    $(function () {
        ...
        $("#widget2").dxRadioGroup({
            ...
            onOptionChanged: function (e) {
                debugger;
                if (e.value === $scope.Listradiogroup2[1]) {
                    ...
                    $scope.$apply(function () {
                        ...
                        $scope.DegreeID = null;
                        $scope.StudentId = null;
                        $scope.FacultyDisabled = true;
                        $scope.DegreeDisabled = true;
                        $scope.StudentStatusAcademyDisabled = true; 
                       // $("#widget3").attr('disabled', true);
                        $scope.StudentDisabled = false;
                    ...
                    $scope.$apply(function () {
                        ...
                        $scope.DegreeID = null;
                        $scope.StudentId = null;
                        $scope.FacultyDisabled = false;
                        $scope.DegreeDisabled = false;
                        $scope.StudentStatusAcademyDisabled = false; 
            ...
            onInitialized: function (e) {
                debugger;
                if ($("#widget2").dxRadioGroup('instance').option('value') === $scope.Listradiogroup2[1]) {
                    $scope.FacultyDisabled = true;
                    $scope.DegreeDisabled = true;
                } else if ($("#widget2").dxRadioGroup('instance').option('value') === $scope.Listradiogroup2[0])
                {
        ...
        $("#widget3").dxRadioGroup({
            layout: "horizontal",
            items: $scope.Listradiogroup3,
            value: $scope.Listradiogroup3[0], 
            onOptionChanged: function (e) {
                debugger;
                if (e.value === $scope.Listradiogroup3[1]) {
                    ...
                    $scope.$apply(function () {
                        ...
                        $scope.DegreeID = null;
                        $scope.StudentId = null;
                        $scope.MDL_StudentStatusAcademy = null;
                        $scope.StudentStatusAcademyDisabled = false;
                        $scope.StudentIds = null;
                    });
                    $scope.StudentSelectedValues = ''; 
    ...
    var DataSourceStudentStatusAcademy = new DevExpress.data.DataSource({
        ...
        loadMode: "raw",
        load: function () {
            return $.getJSON("/CalculationBonus/GetAllRegisterTypes", function (data) { });
        }
    });
    $scope.DL_StudentStatusAcademyId = {
        bindingOptions: {
            ...
            disabled: "StudentStatusAcademyDisabled"
        },
        ...
        onClosed: function (e) {
            ...
            if (e.model.DegreeID) {
                ...
                if ($scope.FacultionIds !== null && $scope.DegreeIds !== null) {
                    ...
                    return $http({
                        method: "Get",
                        url: "/CalculationBonus/GetStudentsData",
                        params: {
                            facultyIds: $scope.FacultionIds,
                            degreeIds: $scope.DegreeIds,
                            StdCodes: $scope.StudentStatusAcademySelectedValues
                        }
                    }).then(function (data) {
                        debugger;
                        $scope.StudentIds = data.data;
                    });
                }
              //  return d.promise();
            }
    ...
    $scope.StudentSelectBox = {
        ...
        onClosed: function (e) {
            debugger;
            $scope.StudentIds = e.model.StudentId;
    ...
    $scope.SaveCalculationBonus = function () {
        ...
        debugger;
        var studentsBox = $('#StudentSelect').dxSelectBox('instance');
        ...
        CalculationBonusSrvc.SaveCalculationBonus(object, $scope.StudentStatusAcademySelectedValues).then(
            function (data) {
                if (data.data.status === 500) {
                    DevExpress.ui.notify({
                        message: data.data.Message,
