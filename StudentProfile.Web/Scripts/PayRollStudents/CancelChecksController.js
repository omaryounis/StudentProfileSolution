app.controller("CancelChecksCtrl", ["$scope", "$http", "CancelChecksSrvc", function ($scope, $http, CancelChecksSrvc) {
    ...
    $scope.PayrollSelectBox = {
        ...
        onInitialized: function (e) {
            //Get Users
            CancelChecksSrvc.GetPayrollWithNotReceiveChecksYet(e.value).then(function (data) {
    ...
    $scope.FacultionSelectBox = {
        ...
        onInitialized: function (e) {
            ...
            CancelChecksSrvc.GetFaculties($scope.userID, $scope.payrollID).then(function (data) {
    ...
    $scope.btnSave = {
        ...
        onClick: function (e) {
            ...
            if ($scope.Check.txtCheckNumberName == '' || $scope.Check.txtCheckNumberName == undefined) {
                ...
                CancelChecksSrvc.saveCheck($scope.Check).then(function (data) {
                    if (data.data !== "")
                        ...
                        if (options.data.IsActive == true && (options.data.IsPrinted == null || options.data.IsPrinted == false)) {
                            $("<div />").dxButton({
                                ...
                                onClick: function (e) {
                                    ...
                                    debugger;
                                    CancelChecksSrvc.GetPayrollCheckById(options.data.ID).then(function (result) {
                                        if (result) {
                                            debugger;
    ...
    $scope.saveBtn = {
        ...
        width: "150",
        onClick: function (e) {
            CancelChecksSrvc.cancelCheck($scope.CheckID).then(function (data) {
                if (data.data !== "")
                    DevExpress.ui.notify(data.data, "error", 5000);
                else {
    ...
    $scope.saveButton = {
        ...
        onClick: function (e) {
            ...
            CancelChecksSrvc.PayrollApprovallAction($scope.currentKey, $scope.recommendationNotes, $scope.payNo, $scope.dafPayNo, true, true)
                .then(function (data) {
                    if (data.data === "") {
        ...
        $http({
            ...
            if (data.data != "") {
                ...
                return $http({
                    ...
                    debugger;
                    $scope.PayRollChecksDetails = datas.data;
                    PayRollChecksDataGridDataSource.reload();
                });
            }
